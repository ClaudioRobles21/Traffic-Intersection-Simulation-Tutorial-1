...
```sh
      $ git clone https://github.com/mihir-m-gandhi/Traffic-Intersection-Simulation-Tutorial-1.git
```
  * Step II: Install the required packages
```sh
      # On the terminal, move into simulation directory
      $ cd Traffic-Intersection-Simulation-Tutorial-1/simulation
      $ pip install pygame
```
